const MODEL_REGISTRY = {
  ...
  Epsilon: {
    ...
    name: '伊普西隆 (Epsilon)',
    nameZh: '伊普西隆',
    description: '标准模型，含眼泪和生气标记等表情效果',
    path: '/models/Epsilon/Epsilon.model3.json',
    thumbnail: '/models/Epsilon/Epsilon.2048/texture_00.png',
    tags: ['表情', '特效', 'VTuber'],
    hasExpressions: true,
    expressionMap: {},
    emotionToExpression: {},
  ...
  Shizuku: {
    ...
    name: '雫 (Shizuku)',
    nameZh: '雫',
    description: '"Shizuku Talk"主模型，手势细腻丰富',
    path: '/models/Shizuku/Shizuku.model3.json',
    thumbnail: '/models/Shizuku/Shizuku.2048/texture_00.png',
    tags: ['手势', 'VTuber', '细腻'],
    hasExpressions: false,
    expressionMap: {},
    emotionToExpression: {},
